---
title: Idempotent multimedia pipelines with Oban: dedupe, uniqueness, and safe retries
...
I added a “video chunking” feature to Momento: split a short video into 10-second chunks, run multi-frame vision analysis per chunk, generate an embedding, and store that chunk so you can search your memories with natural language.
