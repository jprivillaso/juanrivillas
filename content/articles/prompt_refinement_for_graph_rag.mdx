...
implementation to use Graph RAG. In [this post (https://www.juanrivillas.com/blog/naive_rag_vs_graph_rag), I compare both implementations. In this blog post, I will discuss how I enhanced the responses from the Graph RAG implementation through prompt fine-tuning.
