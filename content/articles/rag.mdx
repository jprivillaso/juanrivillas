...
As you see, these are all well-known software engineering decisions that focus more on the architecture and exposing abstractions rather than how we will implement the code itself.
