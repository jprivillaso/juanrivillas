...
**GenServer**: The RAG system runs as a GenServer process, maintaining the vector database in memory and handling concurrent queries efficiently, while keeping the system fault-tolerant.
...
Check out the full implementation [here](https://github.com/jprivillaso/family-tree-agent)
