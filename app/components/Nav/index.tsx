      ...
      >
        <div className="container flex flex-row-reverse items-center justify-between p-6 mx-auto">
          <div className="flex justify-between gap-8">
            ...
            <Link href="/now" className="duration-200 text-zinc-400 hover:text-zinc-100">
              Now
            </Link>
            <Link href="/blog" className="duration-200 text-zinc-400 hover:text-zinc-100">
              Blog
            </Link>
            <Link href="/projects" className="duration-200 text-zinc-400 hover:text-zinc-100">
              Projects
            </Link>
            <Link href="/social" className="duration-200 text-zinc-400 hover:text-zinc-100">
              Social
            </Link>
          </div>
